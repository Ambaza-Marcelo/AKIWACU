...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        $clients = BookingClient::all();
        return view('backend.pages.booking.client.index', compact('clients'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.booking.client.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.booking-clients.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.booking.client.edit', compact('client', 'addresses'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        session()->flash('success', 'BookingClient has been updated !!');
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        session()->flash('success', 'BookingClient has been deleted !!');
        return back();
    }
}
