...
class PlanPurchaseFoodController extends Controller
{
    ...
    public function index()
    {
        ...
        $purchases = PlanPurchaseFood::all();
        return view('backend.pages.plan_purchase_food.index', compact('purchases'));
    }
    ...
    public function create()
    {
        ...
        $drinks  = Food::orderBy('name','asc')->get();
        return view('backend.pages.plan_purchase_food.create', compact('drinks'));
    }
    ...
    public function show($plan_no)
    {
        //
         ...
         $purchases = PlanPurchaseFoodDetail::where('plan_no', $plan_no)->get();
         return view('backend.pages.plan_purchase_food.show', compact('purchases','code'));
    }
    ...
    public function destroy($plan_no)
    {
        ...
        $purchase = PlanPurchaseFood::where('plan_no',$plan_no)->first();
        if (!is_null($purchase)) {
            $purchase->delete();
