...
class SendBillEbmsTask extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send_bill_to_ebms:task';
     ...
     * @var string
     */
    protected $description = 'send bill to electronic billing management system of OBR';
