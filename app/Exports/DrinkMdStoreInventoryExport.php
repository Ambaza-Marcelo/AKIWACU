...
class DrinkMdStoreInventoryExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    */
    public function collection()
    {
        ...
        return DrinkBigStoreInventoryDetail::where('inventory_no',$this->code)->get();
    }
