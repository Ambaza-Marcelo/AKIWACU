            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="seo-fact sbg3">
                        <a href="{{ route('admin.sotb-material-stockouts.selectBgStore') }}">
            ...
            <div class="col-md-6 mb-3 mb-lg-0">
                <div class="card">
                    <div class="seo-fact sbg4">
                        <a href="{{ route('admin.sotb-material-stockouts.selectMdStore') }}">
                            <div class="p-4 d-flex justify-content-between align-items-center">
                                <div class="seofct-icon">
                ...
                <div class="card">
                    <div class="seo-fact sbg3">
                        <a href="{{ route('admin.sotb-material-stockouts.selectSmStore') }}">
                            <div class="p-4 d-flex justify-content-between align-items-center">
                                <div class="seofct-icon">
                                    <img src="{{ asset('img/undraw_cabin_hkfr.svg') }}" width="200">
