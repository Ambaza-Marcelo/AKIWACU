        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.sotb-material-requisitions.index') }}">@lang('messages.list')</a></li>
         ...
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sotb-material-requisitions.store') }}" method="post" id="dynamic_form">
                        @csrf
                        ...
                        <div class="col-sm-6" id="dynamicDiv">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr class="">  
                                ...
                                <option value="{{ $material->material_id }}" class="form-control">{{$material->material->name}}/{{ $material->material->code }}</option>
                                @endforeach
                                </select></td>  
                      ...
                      "<td>"+
                         "<select class='form-control' name='material_id[]'"+
                            "<option>merci de choisir</option>"+
                             "@foreach($materials as $material)"+
                                 "<option value='{{ $material->material_id }}'>{{ $material->material->name }}/{{ $material->material->code }}</option>"+
                             "@endforeach>"+
                          "</select>"+
                        "</td>"+
                        "<td>"+
