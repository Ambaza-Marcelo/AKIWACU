...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left"> List</h4>
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('service.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.services.create') }}">Create New </a>
                        @endif
                    </p>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('service.edit'))
                                            <a class="btn btn-success text-white" href="{{ route('admin.services.edit', $service->id) }}">Edit</a>
                                        @endif
