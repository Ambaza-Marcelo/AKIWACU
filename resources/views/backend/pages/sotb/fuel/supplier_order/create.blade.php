...
@section('title')
@lang('fuel supplier orders') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('fuel supplier orders')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.sotb-fuel-supplier-orders.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('fuel supplier orders')</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sotb-fuel-supplier-orders.store') }}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-6">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <option value="{{ $data->fuel_id }}" class="form-control">{{ $data->fuel->name }}</option>
                                </select></td>  
                    ...
                    -->
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description" id="description" placeholder="Enter Desccription">
                                COMMANDE DU CARBURANT CHEZ LE FOURNISSEUR
                            </textarea>
                        </div>
                         ...
                         "<select class='form-control' name='fuel_id[]'"+
                            "<option value='0'>Merci de choisir</option>"+
                             "@foreach($fuels as $fuel)"+
                                 "<option value='{{ $fuel->id }}'>{{ $fuel->name }}/{{ $fuel->code }}</option>"+
                             "@endforeach>"+
                          "</select>"+
                        "</td>"+
                        "<td>"+
