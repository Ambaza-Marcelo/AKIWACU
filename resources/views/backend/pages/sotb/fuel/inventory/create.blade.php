        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-warning">
                    ...
                    <form action="{{ route('admin.fuel_inventories.store') }}" method="POST">
                        @csrf
                        <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="form-group">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr class="bg-warning">  
                                ...
                                <option value="{{ $data->id }}" selected="selected" class="form-control">{{ $data->designation }}/{{ $data->fuel->nom }}</option>
                                </select></td>  
                                <td><input type="text" name="quantite[]" value="{{$data->quantite }}" class="form-control" readonly="readonly" /></td>  
                                <td><input type="text" name="prix_unitaire[]" value="{{ $data->prix_unitaire }}" class="form-control" readonly="readonly"/></td>
                                ...
                                <td><input type="number" name="nouveau_prix[]" value="{{ $data->prix_unitaire }}" class="form-control" step="any" min="0"/></td>
