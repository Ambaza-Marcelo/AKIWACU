            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('sotb_fuel_pump.create'))
                            <a class="btn btn-success text-white" href="" title="Exporter en PDF"><i class="fa fa-file-pdf-o"></i>&nbsp;Exporter</a>
                            <a class="btn btn-primary text-white" href="{{ route('admin.sotb-fuel-pumps.create') }}">Nouveau</a>
                        @endif
                    </p>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::guard('admin')->user()->can('sotb_fuel_pump.delete'))
                                            <a class="btn btn-info text-white" href="{{ route('admin.sotb-fuel-pumps.edit', $pump->id) }}">
                                                Editer
                                            </a>
                                        @endif

                                        @if (Auth::guard('admin')->user()->can('sotb_fuel_pump.delete'))
                                            <a class="btn btn-danger text-white" href="{{ route('admin.sotb-fuel-pumps.destroy', $pump->id) }}"
                                            ...
                                            <form id="delete-form-{{ $pump->id }}" action="{{ route('admin.sotb-fuel-pumps.destroy', $pump->id) }}" method="POST" style="display: none;">
                                                @method('DELETE')
                                                @csrf
                                            </form>
                                        @endif
