        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sotb-material-stockins.store') }}" method="POST">
                        @csrf
                    <input type="hidden" name="store_type" value="md">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="destination_md_store_id" id="destination_md_store_id">
                                    <option disabled="disabled" selected="selected">Merci de choisir</option>
                                    @foreach($destination_stores as $destination_store)
                                        <option value="{{$destination_store->id}}" {{ $destination_store->code == $code ? 'selected' : '' }}>{{$destination_store->name}}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
