        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sotb-material-stockins.storeFromSmall') }}" method="POST">
                        @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="destination_sm_store_id" id="destination_sm_store_id">
                                    <option disabled="disabled" selected="selected">Merci de choisir</option>
