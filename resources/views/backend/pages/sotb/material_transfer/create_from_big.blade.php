        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.sotb-material-transferts.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sotb-material-transferts.storeFromBig') }}" method="POST">
                        @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="origin_bg_store_id">@lang('Stock Origine')</label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="destination_md_store_id">@lang('Stock Destination')</label>
                                <select class="form-control" name="destination_md_store_id" id="destination_md_store_id" required>
                                 <option disabled="disabled" selected="selected">Merci de choisir</option>
