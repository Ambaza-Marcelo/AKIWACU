...
@section('title')
@lang('Details sur Bon Expedition') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Details sur Bon Expedition')</h4>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Details sur le Bon Expedition No {{ $facture->invoice_number }}</h4>
                    @include('backend.layouts.partials.messages')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label>Signature Electronique Expedition</label>
                                <input type="text" value="{{ $facture->invoice_signature}}" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="invoice_type">Type Expedition</label>
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><input type="text" value="{{ $factureDetail->privateStoreItem->name }}" class="form-control" readonly></td>  
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ route('admin.private-factures.generatepdf',$factureDetail->invoice_number) }}"><img src="{{ asset('img/ISSh.gif') }}" width="60" title="Télécharger d'abord le document et puis imprimer"></a> 
                        @endif
                    </form>
                </div>
            </div>
