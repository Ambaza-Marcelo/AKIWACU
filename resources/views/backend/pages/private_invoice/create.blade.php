...
@section('title')
@lang('Expedition magasin eden') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Expedition magasin eden')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.private-factures.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Expedition magasin eden')</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Nouveau Expedition</h4>
                    ...
                    <form action="{{ route('admin.private-factures.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="invoice_date">Date Expedition</label>
                                <input type="date" placeholder="Date Expedition" name="invoice_date" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
