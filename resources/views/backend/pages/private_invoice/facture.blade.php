...
<div>
    <div>
        <div>
                <div>
                        <small>
                           <strong style="text-decoration: underline;">Facture No : {{ $invoice_number }} du {{ \Carbon\Carbon::parse($data->created_at)->format('d/m/Y H:i:s') }}</strong>
                        </small><br>
                    </div>
                    ...
                    -->
                        <small><strong>
                           &nbsp;&nbsp;Net à payer : {{ number_format($item_total_amount,0,',',' ' )}}</strong>
                        </small>
                        </div>
                    </div>
                    <!--
