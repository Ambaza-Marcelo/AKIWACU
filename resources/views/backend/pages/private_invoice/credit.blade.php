        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.private-factures.validate-credit',$facture->invoice_number) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><input type="text" name="item_designation[]" value="{{ $data->privateStoreItem->name }}" class="form-control" readonly /></td>  
