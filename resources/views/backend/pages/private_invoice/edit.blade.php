...
@section('title')
@lang('modifier facture magasin Eden') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('modifier facture magasin Eden')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.private-factures.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('modifier facture magasin Eden')</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.private-factures.update',$invoice_number) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <td><input type="number" step='any' min='0' value="{{ $data->quantity }}" name="item_quantity[]" class="form-control" /></td>  
                                <td><input type="number" step='any' min='0' value="{{ $data->selling_price }}" name="item_price[]" class="form-control" /></td>
                                <td>
