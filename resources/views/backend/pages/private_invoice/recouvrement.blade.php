...
@section('title')
@lang('Recouvrement') - @lang('messages.admin_panel')
@endsection
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Recouvrement</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.private-factures.recouvrement',$facture->invoice_number) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="customer_name" value="{{ $facture->customer_name}}" class="form-control">
                            </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="item_designation[]" value="@if($data->private_store_item_id) {{ $data->privateStoreItem->name }} @endif" class="form-control" readonly /></td>  
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Recouvrer</button>
                    </form>
                </div>
            </div>
        </div>
