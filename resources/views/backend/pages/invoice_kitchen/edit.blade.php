...
@section('title')
@lang('Modifier facture Cuisine') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Modifier facture Cuisine')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.invoice-kitchens.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Modifier facture Cuisine')</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('ebms_api-facture-cuisine.update',$invoice_number) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="food_order_no" class="form-control" value="{{ $data->food_order_no }}" readonly>
                            </div>
                            <div class="col-md-4">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><select class="form-control" name="food_item_id[]" id="food_item_id">
                                    ...
                                    <option value="{{ $data->food_item_id }}" {{ $data->food_item_id === $food_item->id ? 'selected' : '' }} class="form-control">{{ $data->foodItem->name }}/{{ $data->foodItem->code }}</option>
                                    @endforeach
                                </select></td>  
                                <td><input type="number" step='any' min='0' value="{{ $data->quantity }}" name="item_quantity[]" class="form-control" @if(Auth::guard('admin')->user()->can('invoice_kitchen.delete')) @else readonly @endif/></td>  
                                <td><input type="number" step='any' min='0' value="{{ $data->selling_price }}" name="item_price[]" placeholder="Prix" class="form-control" @if(Auth::guard('admin')->user()->can('invoice_kitchen.delete')) @else readonly @endif/></td>
                                <td><input type="number" step='any' min='0' name="item_ct[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('invoice_kitchen.delete')) @else readonly @endif/></td>   
                                <td><input type="number" step='any' min='0' name="item_tl[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('invoice_kitchen.delete')) @else readonly @endif/></td>
                                <td>@if(Auth::guard('admin')->user()->can('invoice_kitchen.delete'))
