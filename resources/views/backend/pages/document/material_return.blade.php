            ...
            <div>
                ...
                <div>
                    ...
                    <div style="float: right; border-top-right-radius: 10px solid black;border-top-left-radius: 10px solid black;border-bottom-right-radius: 10px solid black;border-bottom-left-radius: 10px solid black; background-color: rgb(150,150,150);width: 242px;padding: 20px;">
                        <small>
                           &nbsp;&nbsp; <img src="data:image/png;base64, {!! base64_encode(QrCode::size(50)->generate('eSIGNATURE : '.$return_signature.' www.edengardenresorts.bi, return number : '.$return_no)) !!} ">
                        </small><br>
                        <small>
                           &nbsp;&nbsp;DU: PETIT STOCK AU STOCK INTERMEDIAIRE
                        </small><br>
                        <small>
                           &nbsp;&nbsp;Return Number: {{ $return_no }}
                        </small><br>
                        <small>
                    ...
                    <br><br><br>
                    <div>
                        <h3 style="text-align: center;text-decoration: underline;">BON DE RETOUR DES ARTICLES</h3>
                    </div>
                    <div>
                        <table style="border: 1px solid black;border-collapse: collapse;">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{{ number_format($data->total_value_returned,0,',',' ' )}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <th>{{ number_format($totalValueReturned,0,',',' ') }}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
