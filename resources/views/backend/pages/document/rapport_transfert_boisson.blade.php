            ...
            <div>
               <div>
                ...
                <div>
                    ...
                    <br>
                    <div>
                        <h2 style="text-align: center;text-decoration: underline;">JOURNAL DE TRANSFERT(BOISSON) DU {{ \Carbon\Carbon::parse($start_date)->format('d/m/Y') }} AU {{ \Carbon\Carbon::parse($end_date)->format('d/m/Y') }} </h2>
                    </div>
                    <br>
                    <div>
                        <table style="border: 1px solid black;border-collapse: collapse;">
                            <thead>
                                <tr>
                                    <th width="5%">No</th>
                                    <th width="10%">Date</th>
                                    <th width="10%">No Transfert</th>
                                    <th width="10%">Approuvee par</th>
