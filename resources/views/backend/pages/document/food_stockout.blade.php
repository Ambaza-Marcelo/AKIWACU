            ...
            <div>
                ...
                <div>
                    ...
                    <div style="float: right; border-top-right-radius: 10px solid black;border-top-left-radius: 10px solid black;border-bottom-right-radius: 10px solid black;border-bottom-left-radius: 10px solid black; background-color: rgb(150,150,150);width: 242px;padding: 20px;">
                        <small>
                           &nbsp;&nbsp; <img src="data:image/png;base64, {!! base64_encode(QrCode::size(50)->generate('eSIGNATURE : '.$stockout_signature.' www.edengardenresorts.bi, Stockout Number : '.$stockout_no)) !!} ">
                        </small><br>
                        <small>
                    ...
                    <br><br><br>
                    <div>
                        <h3 style="text-align: center;text-decoration: underline;">FICHE DE SORTIE DES ARTICLES</h3>
                    </div>
                    <div>
                        <table style="border: 1px solid black;border-collapse: collapse;">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>@if($data->quantity_portion){{ $data->food->foodMeasurement->production_unit }} @else {{ $data->food->foodMeasurement->purchase_unit }} @endif</td>
