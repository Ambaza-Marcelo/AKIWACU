        ...
        <div>
            <div>
                ...
                <div>
                    ...
                    <br><br><br>
                    <div>
                        <h2 style="text-align: center;text-decoration: underline;">RAPPORT DU STOCK DES BOISSONS (GRAND STOCK) VERS LA BARRIST</h2>
                    </div>
                    <div>
                        <table style="border: 1px solid black;border-collapse: collapse;">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>@if($data->value_stockout){{ number_format($data->value_stockout,0,',',' ') }} @elseif($data->value_transfer) {{ number_format($data->value_transfer,0,',',' ') }} @endif </td>
                                    ...
                                    <td>{{ number_format((($data->quantity_stock_initial + $data->quantity_stockin + $data->quantity_reception) - ($data->quantity_stockout + $data->quantity_transfer))*$data->drink->purchase_price,0,',',' ') }} </td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
