                        ...
                        <table style="border: 1px solid black;border-collapse: collapse;">
                            <thead>
                                <tr>
                                    ...
                                    <th>Article</th>
                                    <th>Code</th>
                                    <th>Qté Actuelle/Portion</th>
                                    <th>PU Actuelle</th>
                                    <th style="background-color: rgb(150,150,150);">V. Stock Actuelle</th>
                                    <th>Nouvelle Qté/Portion</th>
                                    <th>N. PU</th>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{{ $data->quantity }}/{{ $data->quantity_portion }}</td>
                                    ...
                                    <td>{{ $data->new_quantity }}/{{ $data->new_quantity_portion }}</td>
