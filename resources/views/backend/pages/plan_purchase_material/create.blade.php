...
@section('title')
@lang('Planification des approvisionnements des materiels') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Planification des approvisionnements des materiels')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.plan-purchase-materials.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Planification des approvisionnements des materiels')</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        <!-- data table start -->
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Planification des approvisionnements des materiels</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.plan-purchase-materials.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
