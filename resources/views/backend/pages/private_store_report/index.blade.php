...
@section('title')
@lang('RAPPORT DU MAGASIN EGR') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('RAPPORT DU MAGASIN EGR')</h4>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.private-store-report.export-to-excel')}}" method="GET">
                    ...
                    <form action="{{ route('admin.private-store-report.export-to-pdf')}}" method="GET">
                        <table>
                            <tr>
                                <th>Date Debut</th>
                                <th>Date Fin</th>
