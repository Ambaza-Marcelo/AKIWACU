                ...
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('booking_kidness_space.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.booking-kidness-space.create') }}">@lang('messages.new')</a>
                        @endif
                    </p>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_kidness_space.validate'))
                                        @if($booking->status == 0 || $booking->status == -1)
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_kidness_space.reject'))
                                        ...
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_kidness_space.reset'))
                                        ...
                                        @endif
                                        @if($booking->status == 1)
                                        @if (Auth::guard('admin')->user()->can('invoice_kidness_space.create'))
