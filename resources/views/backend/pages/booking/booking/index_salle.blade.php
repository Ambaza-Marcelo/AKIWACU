                ...
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('booking_salle.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.booking-salles.create') }}">@lang('messages.new')</a>
                        @endif
                    </p>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_salle.validate'))
                                        @if($booking->status == 0 || $booking->status == -1)
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_salle.reject'))
                                        ...
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_salle.reset'))
