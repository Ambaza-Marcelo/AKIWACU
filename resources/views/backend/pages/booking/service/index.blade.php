...
@section('title')
@lang('Liste des services') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Liste des services')</h4>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">@lang('Liste des services')</h4>
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('booking_service.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.services.create') }}">@lang('messages.new')</a>
                        @endif
                    </p>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('booking_service.edit'))
                                            <a class="btn btn-success text-white" href="{{ route('admin.services.edit', $service->id) }}">@lang('messages.edit')</a>
                                        @endif
