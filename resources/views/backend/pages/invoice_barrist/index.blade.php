                                ...
                                -->
                                    ...
                                    <td>
                                        ...
                                        @if($facture->cancelled_invoice != 1)
                                         <a href="{{ route('admin.barrista-note-de-credit.create', $facture->invoice_number) }}" class="btn btn-success">Facture d'Avoir</a>
                                        @endif
                                        @endif 
                                        @endif
                                        ...
                                        @if($facture->etat == 1 || $facture->etat == 01)
                                        @if($facture->cancelled_invoice != 1)
                                         <a href="{{ route('admin.barrista-remboursement-caution.create', $facture->invoice_number) }}" class="btn btn-success">Remboursement Caution</a>
                                        @endif
                                        @endif
                                        @endif 
