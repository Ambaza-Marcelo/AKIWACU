    ...
    <div>
        <div>
                ...
                <div><br>
                        ...
                        <table style="border: 1px solid black;border-collapse: collapse;">
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                @if($note_credit > 0)
                                <tr>
                                    <td>NOTE DE CREDIT</td>
                                    <td>-{{ number_format(($note_credit_pvhtva * 2),0,',',' ' )}}</td>
                                    <td>-{{ number_format(($note_credit_tva * 2),0,',',' ' )}}</td>
                                    <td>-{{ number_format(($note_credit * 2),0,',',' ' )}}</td>
                                </tr>
                                @endif
                            </tbody>
                            <tfoot>
                    ...
                    <br><br><br>
                    <small>
                           &nbsp;&nbsp; <img src="data:image/png;base64, {!! base64_encode(QrCode::size(100)->generate('www.edengardenresorts.bi, '.number_format(($item_total_amount_drink + $item_total_amount_kitchen + $item_total_amount_barrista + $item_total_amount_bartender + $item_total_amount_service) - ($note_credit * 2),0,',',' ').' ,powered by https://ambazamarcellin.netlify.app/')) !!} ">
                    </small>
            </div>
            <div class="watermark">
                <hr>
