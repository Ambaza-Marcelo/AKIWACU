                        ...
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    ...
                                    <th width="10%">@lang('Nbre Portions')</th>
                                    <th width="10%">@lang('messages.purchase_price')</th>
                                    <th width="10%">@lang('messages.new_quantity')</th>
                                    <th width="10%">@lang('N. Nbre Portions')</th>
                                    <th width="10%">@lang('messages.purchase_price')</th>
                                    <th width="10%">@lang('messages.total_amount_purchase')</th>
                                    <th width="10%">Relicat</th>
                                    <th width="10%">Relicat Portion</th>
