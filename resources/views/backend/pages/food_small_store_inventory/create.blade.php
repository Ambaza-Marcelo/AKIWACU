                        ...
                        <div class="row">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr class="">  
                                ...
                                <td><input type="text" name="quantity[]" value="{{$data->quantity_portion }}" class="form-control" readonly="readonly" /></td>
                                <td><input type="text" name="purchase_price[]" value="{{ $data->purchase_price }}" class="form-control" readonly="readonly"/></td> 
                                <td><input type="number" name="new_quantity[]" value="{{ $data->quantity_portion }}" class="form-control" step="any" min="0" /></td>
