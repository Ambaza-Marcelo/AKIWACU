        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.food-small-store-inventory.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-success">
                    ...
                    <form action="{{ route('admin.food-small-store-inventory.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="INVENTAIRE AU PETIT STOCK DES NOURRITURES DU {{ date('d') }} ,{{date('M')}} {{ date('Y')}}">
                            </div>
                        </div>
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr class="">  
                                ...
                                <input type="hidden" name="selling_price[]" value="{{ $data->selling_price }}">
                                ...
                                <td><input type="text" name="quantity_portion[]" value="{{ $data->quantity_portion }}" class="form-control" readonly="readonly"/></td>  
                                ...
                                <td><input type="number" name="new_quantity_portion[]" value="{{ $data->new_quantity_portion }}" class="form-control" step="any" min="0" /></td>
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description" id="description">
                              INVENTAIRE AU PETIT STOCK DES NOURRITURES DU {{ date('d') }} ,{{date('M')}} {{ date('Y')}}
                            </textarea>
                        </div>
