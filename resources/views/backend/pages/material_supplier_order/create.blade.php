...
@section('title')
@lang('Create material supplier order') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Create material supplier order')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.material-supplier-orders.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Create material supplier order')</span></li>
                </ul>
            </div>
        </div>
