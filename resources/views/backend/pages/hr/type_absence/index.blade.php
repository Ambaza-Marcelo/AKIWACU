            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                            <a class="btn btn-primary text-white" href="{{ route('admin.positions.create') }}">@lang('messages.new')</a>
                    </p>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{{ $position->name }}</td>
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('positions.edit'))
                                            <a class="btn btn-success text-white" href="{{ route('admin.positions.edit', $position->id) }}">Editer</a>
                                        @endif

                                        @if (Auth::guard('admin')->user()->can('positions.delete'))
