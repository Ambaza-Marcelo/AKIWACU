                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>@if($transfer->status == 1)<img src="{{ asset('img/warning3.gif')}}" width="35">@elseif($transfer->status == 1)<span class="badge badge-info">Encours</span> @elseif($transfer->status == 2)<span class="badge badge-info">Validé</span> @elseif($transfer->status == -1)<span class="badge badge-danger">Rejeté</span>@elseif($transfer->status == 3)<span class="badge badge-info">Confirmé</span> @elseif($transfer->status == 4)<span class="badge badge-success">Approuvé</span>@endif</td>
