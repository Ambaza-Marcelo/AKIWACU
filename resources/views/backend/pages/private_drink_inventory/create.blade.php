        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.private-drink-inventory.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.private-drink-inventory.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="INVENTAIRE AU STOCK DES BOISSONS (PDG) DU {{ date('d') }} ,{{date('M')}} {{ date('Y')}}">
                            </div>
                        </div>
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr class="">
                                ...
                                <td> <select class="form-control" name="private_store_item_id[]" id="private_store_item_id">
                                <option value="{{ $data->id }}" selected="selected" class="form-control">{{ $data->name }}/{{ $data->code }}</option>
                                </select></td>  
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description" id="description">
                              INVENTAIRE AU STOCK DES BOISSONS (PDG) DU {{ date('d') }} ,{{date('M')}} {{ date('Y')}}
                            </textarea>
                        </div>
