        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.material-transfers.index') }}">@lang('messages.list')</a></li>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">@lang('TRANSFERT DES ARTICLES DE GRAND STOCK VERS STOCK INTERMEDIAIRE')</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.material-transfers.storeFromBig') }}" method="POST">
                        @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="origin_extra_store_id">@lang('Stock Origine')</label>
                                <select class="form-control" name="origin_extra_store_id" id="origin_extra_store_id" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="destination_bg_store_id" id="destination_bg_store_id" required>
                                 <option disabled="disabled" selected="selected">Merci de choisir</option>
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <td><input type="number" name="price[]" value="{{$data->price}}" class="form-control" step="any" readonly /></td>
