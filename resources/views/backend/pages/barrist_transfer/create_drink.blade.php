        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-success">
                    ...
                    <form action="{{ route('admin.barrist-transfer-drink.store') }}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="origin_dstore_id">@lang('Stock Origine')</label>
                                <select class="form-control" name="origin_dstore_id" id="origin_dstore_id">
