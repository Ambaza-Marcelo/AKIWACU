...
@section('title')
@lang('Drink Extra Big Store Detail') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Drink Extra Big Store Detail : '){{ $drink_big_store->code }}</h4>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">@lang('Drink Extra Big Store Detail : '){{ $drink_big_store->code }}</h4>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    @if($drink_big_store->quantity <= $drink_big_store->threshold_quantity)
                                    <td>{{ $drink_big_store->quantity }}<img src="{{ asset('img/warning.gif')}}" width="30"></td>
                                    @else
                                    <td>{{ $drink_big_store->quantity }}</td>
                                    @endif
