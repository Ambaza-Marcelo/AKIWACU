        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.f-bartender-orders.index',$table_id) }}">@lang('messages.list')</a></li>
         ...
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.f-bartender-orders.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
                      ...
                      "<td>"+
                        ...
                        "<td>"+
                         "<select class='form-control' name='unit[]'"+
                            "<option>merci de choisir</option>"+
                                 "<option value='verres'>Verre</option>"+
                                 "<option value='godets'>Godet</option>"+
                          "</select>"+
                        "</td>"+
                        "<td>"+
