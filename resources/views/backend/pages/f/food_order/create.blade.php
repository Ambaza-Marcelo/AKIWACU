        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.f-food-orders.index',$table_id) }}">@lang('messages.list')</a></li>
         ...
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.f-food-orders.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description" id="description" placeholder="Enter Description">
                                COMMANDE CLIENT DES NOURRITURES
                            </textarea>
                        </div>
