        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.f-booking-bills.choose') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.f-booking-bills.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <td><input type="number" step='any' min='0' value="{{ $booking->quantity }}" name="item_quantity[]" placeholder="Quantite" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.delete')) @else readonly @endif/></td>  
                                <td><input type="number" step='any' min='0' value="{{ $booking->selling_price }}" name="item_price[]" placeholder="Prix" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.delete')) @else readonly @endif/></td>
                                <td><input type="number" step='any' min='0' name="item_ct[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.delete')) @else readonly @endif/></td>   
                                <td><input type="number" step='any' min='0' name="item_tl[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.delete')) @else readonly @endif/></td>
                                <td>@if(Auth::guard('admin')->user()->can('f_bill.delete'))<button type='button' class='btn btn-danger remove-tr'><i class='fa fa-trash-o' title='Supprimer la ligne' aria-hidden='false'></i></button>@endif</td> 
                            </tr>
                            ...
                            <tr>  
                                ...
                                <td><input type="number" step='any' min='0' value="{{ $booking->quantity }}" name="item_quantity[]" placeholder="Quantite" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.edit')) @else readonly @endif/></td>  
                                <td><input type="number" step='any' min='0' value="{{ $booking->selling_price }}" name="item_price[]" placeholder="Prix" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.edit')) @else readonly @endif/></td>
                                <td><input type="number" step='any' min='0' name="item_ct[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.edit')) @else readonly @endif/></td>   
                                <td><input type="number" step='any' min='0' name="item_tl[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.edit')) @else readonly @endif/></td>
                                <td>@if(Auth::guard('admin')->user()->can('f_bill.edit'))<button type='button' class='btn btn-danger remove-tr'><i class='fa fa-trash-o' title='Supprimer la ligne' aria-hidden='false'></i></button>@endif</td> 
                            </tr>
                            ...
                            <tr>  
                                ...
                                <td><input type="number" step='any' min='0' name="item_ct[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.edit')) @else readonly @endif/></td>   
                                <td><input type="number" step='any' min='0' name="item_tl[]" value="0" class="form-control" @if(Auth::guard('admin')->user()->can('f_bill.edit')) @else readonly @endif/></td>
                                <td>@if(Auth::guard('admin')->user()->can('invoice_service.edit'))<button type='button' class='btn btn-danger remove-tr'><i class='fa fa-trash-o' title='Supprimer la ligne' aria-hidden='false'></i></button>@endif</td> 
                            </tr>
