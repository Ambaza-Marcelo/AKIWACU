                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 mb-lg-0">
                            ...
                            <div class="seo-fact sbg3">
                                <a href="{{ route('admin.f-booking-swiming-pool-bills.index') }}">
                        ...
                        <div class="col-md-4 mb-3 mb-lg-0">
                            <div class="card">
                            <div class="seo-fact sbg3">
                                <a href="{{ route('admin.f-booking-salle-bills.index') }}">
                                    <div class="p-4 d-flex justify-content-between align-items-center">
                                        <div class="seofct-icon">
                        ...
                        <div class="col-md-4 mb-3 mb-lg-0">
                            <div class="card">
                            <div class="seo-fact sbg3">
                                <a href="{{ route('admin.f-booking-kidness-space-bills.index') }}">
                                    <div class="p-4 d-flex justify-content-between align-items-center">
                                        <div class="seofct-icon">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 mb-lg-0">
                            <div class="card">
                            <div class="seo-fact sbg3">
                                <a href="{{ route('admin.f-booking-service-bills.index') }}">
                                    <div class="p-4 d-flex justify-content-between align-items-center">
                                        <div class="seofct-icon">
                        ...
                        <div class="col-md-4 mb-3 mb-lg-0">
                            <div class="card">
                            <div class="seo-fact sbg3">
                                <a href="{{ route('admin.f-booking-room-bills.index') }}">
                                    <div class="p-4 d-flex justify-content-between align-items-center">
                                        <div class="seofct-icon">
