                    ...
                    @include('backend.layouts.partials.messages')
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="text" value="@if($facture->client_id){{ $facture->client->customer_name }} @elseif($facture->booking_client_id) {{ $facture->bookingClient->customer_name }} @else {{ $facture->customer_name }} @endif" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><input type="text" value="@if($factureDetail->drink_id){{ $factureDetail->drink->name }} @elseif($factureDetail->food_item_id){{ $factureDetail->foodItem->name }} @elseif($factureDetail->bartender_item_id){{ $factureDetail->bartenderItem->name }} @elseif($factureDetail->salle_id){{ $factureDetail->salle->name }} @elseif($factureDetail->service_id){{ $factureDetail->service->name }}  @elseif($factureDetail->room_id) {{ $factureDetail->room->name }} @elseif($factureDetail->swiming_pool_id) {{ $factureDetail->swimingPool->name }} @elseif($factureDetail->kidness_space_id) {{ $factureDetail->kidnessSpace->name }} @else {{ $factureDetail->barristItem->name }} @endif" class="form-control" readonly></td>  
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ route('admin.expedition.print',$facture->invoice_number) }}"><img src="{{ asset('img/ISSh.gif') }}" class="btnprn" width="60" title="Télécharger d'abord le document et puis imprimer"></a> 
                        @endif
                    </form>
                </div>
            </div>
