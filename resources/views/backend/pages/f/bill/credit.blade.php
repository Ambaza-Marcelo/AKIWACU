        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--
                    <form action="@if($facture->drink_order_no){{ route('admin.f-drink-bill.valider-credit', $facture->invoice_number) }} @elseif($facture->food_order_no){{ route('admin.f-food-bill.valider-credit', $facture->invoice_number) }} @elseif($facture->barrist_order_no){{ route('admin.f-barrista-bill.valider-credit', $facture->invoice_number) }} @elseif($facture->bartender_order_no){{ route('admin.f-bartender-bill.valider-credit', $facture->invoice_number) }} @elseif($facture->booking_no){{ route('admin.f-booking-bill.valider-credit', $facture->invoice_number) }} @endif" method="POST"> -->
                        @csrf
                        @method('PUT')
