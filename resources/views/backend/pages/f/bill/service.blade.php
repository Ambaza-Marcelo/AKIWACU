...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Liste des factures(Service)</h4>
                        ...
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                ...
                                -->
                                    ...
                                    <th width="10%">Designation Service</th>
                            ...
                            @foreach($factures as $facture)
                               <tr>
                                ...
                                -->
                                    ...
                                    <td><span class="badge badge-success">{{ $facture->service->name }}</span></td>
