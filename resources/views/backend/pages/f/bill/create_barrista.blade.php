        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.f-barrista-bills.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.f-barrista-bills.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            @if($table_id)
                            <div class="col-md-6">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <option value="{{ $order->barrist_item_id }}" class="form-control">{{ $order->barristItem->name }}</option>
                                </select></td>  
                          ...
                          "<select class='form-control' name='barrist_item_id[]'"+
                            "<option>merci de choisir</option>"+
                             "@foreach($barrist_items as $barrist_item)"+
                                 "<option value='{{ $barrist_item->id }}'>{{ $barrist_item->name }}</option>"+
                             "@endforeach>"+
                          "</select>"+
                        "</td>"+
                        "<td>"+
