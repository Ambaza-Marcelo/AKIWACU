...
<!-- start f -->
@if (Auth::guard('admin')->user()->can('f_drink_order.view') || Auth::guard('admin')->user()->can('f_food_order.view') || Auth::guard('admin')->user()->can('f_barrista_order.view') || Auth::guard('admin')->user()->can('f_bartender_order.view'))
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="card">
                                <div class="seo-fact sbg3">
                                    <a href="{{ route('admin.f-barrista-orders.index',$table_id) }}">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon">
                                                <img src="{{ asset('img/undraw_beer-006.svg') }}" width="200">

                                            @lang('Commande Barrista')</div>
                                            <h2>
                                            </h2>
                                        </div>
                                    </a>
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="card">
                                <div class="seo-fact sbg3">
                                    <a href="{{ route('admin.f-bartender-orders.index',$table_id) }}">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon">
                                                <img src="{{ asset('img/undraw_beer-006.svg') }}" width="200">
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="card">
                                <div class="seo-fact sbg5">
                                    <a href="{{ route('admin.f-drink-orders.index',$table_id) }}">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon">
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="card">
                                <div class="seo-fact sbg6">
                                    <a href="{{ route('admin.f-food-orders.index',$table_id) }}">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon">
