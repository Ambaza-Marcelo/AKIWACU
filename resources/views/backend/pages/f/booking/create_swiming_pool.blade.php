...
@section('title')
@lang('Formulaire de reservation Piscine') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Formulaire de reservation Piscine')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.f-booking-swiming-pool.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Formulaire de reservation Piscine')</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        <!-- data table start -->
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Formulaire de reservation Piscine</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.f-booking-swiming-pool.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><select class="form-control" name="swiming_pool_id[]" id="swiming_pool_id" required>
                                <option disabled="disabled" selected="selected">merci de choisir</option>
                                @foreach($articles as $article)
                                <option value="{{ $article->id }}" class="form-control">{{ $article->name }}/{{number_format($article->selling_price,0,',',' ') }}</option>
                                @endforeach
                                </select></td>  
                                <td><input type="number" name="quantity[]" min="0" placeholder="Entrer quantite" class="form-control" required /></td>
...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    ...
    $("#add").click(function(){
        ...
        ++i;
         ...
         var markup = "<tr>"+
                      "<td>"+
                         "<select class='form-control' name='swiming_pool_id[]' required"+
