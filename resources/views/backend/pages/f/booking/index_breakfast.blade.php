...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Break Fast</h4>
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('booking_breakfast.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.booking-breakfast.create') }}">@lang('messages.new')</a>
                        @endif
                    </p>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>@if($booking->breakfast_id) BREAKFAST @endif</td>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_breakfast.validate'))
                                        @if($booking->status == 0 || $booking->status == -1)
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_breakfast.reject'))
                                        ...
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('booking_breakfast.reset'))
