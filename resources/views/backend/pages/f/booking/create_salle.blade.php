...
@section('title')
@lang('Formulaire de reservation des salles de conferences et reunions') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Formulaire de reservation des salles de conferences et reunions')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.f-booking-salles.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Formulaire de reservation des salles de conferences et reunions')</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        <!-- data table start -->
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Formulaire de reservation des salles de conferences et reunions</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.f-booking-salles.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
                                ...
                                <td>
                                        ...
                                        @foreach ($techniques as $technique)
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" name="technique_id[]" id="{{ $technique->id }}" value="{{ $technique->id }}">
                                                <label class="form-check-label" for="{{ $technique->id }}">{{ $technique->name }}</label>
                                            </div>
                                        @endforeach
