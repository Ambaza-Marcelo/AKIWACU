...
@section('title')
@lang('Modifier Commande Boisson') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Modifier Commande Boisson')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.f-drink-orders.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Modifier Commande Boisson')</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        <!-- data table start -->
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Modifier Commande Boisson</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.f-drink-orders.update',$data->order_no) }}" method="post" id="dynamic_form">
                        @csrf
                        @method('PUT')
                    <div class="row">
