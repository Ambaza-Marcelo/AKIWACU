...
@section('title')
@lang('Planification des approvisionnements des boissons') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Planification des approvisionnements des boissons')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.plan-purchase-drinks.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Planification des approvisionnements des boissons')</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        <!-- data table start -->
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Planification des approvisionnements des boissons</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.plan-purchase-drinks.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6" id="dynamicDiv">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr class="">  
                                ...
                                <td><input type="number" name="purchase_price[]" placeholder="Enter purchase Price" class="form-control" min="0" required /></td> 
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description" id="description" placeholder="Enter Description">
                                PLANIFICATION DES APPROVISIONNEMENTS DE LA SEMAINE DU 
                            </textarea>
                        </div>
        ...
        ++i;
         ...
         var markup = "<tr>"+
                      "<td>"+
                        ...
                        "</td>"+
                        "<td>"+
                          "<input type='number' name='price[]' placeholder='Enter purchase Price' class='form-control' min='0' required/>"+
                        "</td>"+
                        "<td>"+
