                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            @foreach($factures as $facture)
                               <tr>
                                    ...
                                    @if($facture->etat_recouvrement == '1')<span class="badge badge-info" title="MONTANT RESTANT : {{ number_format($facture->reste_credit,0,',',' ') }}">Paiement Partiel</span> @elseif($facture->etat_recouvrement == '2')<span class="badge badge-success" title="MONTANT RECOUVRE : {{ number_format($facture->montant_recouvre,0,',',' ') }}">Paiement Total</span>@else<span class="badge badge-warning" title="MONTANT A RECOUVRER : {{ number_format($facture->montant_total_credit,0,',',' ') }}">Encours..</span> @endif</td>
