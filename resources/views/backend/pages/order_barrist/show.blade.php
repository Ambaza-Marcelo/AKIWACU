...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Details sur le Bon de commande No : {{$order_no}}</h4>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{{ $orderDetail->barristItem->name }}</td>
                                    <td>@foreach($ingredients as $ingred) <small class="badge badge-info">{{ $ingred->ingredient->name }}</small>  @endforeach</td>
