                ...
                <div class="card-body">
                    ...
                    @if ($in_pending > 0)
                        <p class="float-right mb-2">
                            <a href="{{ route('admin.barrist-invoices.create-by-table',$table_id) }}" class="btn btn-success">Cloturer toute la table</a>
                        </p>
                        <p class="float-right mb-2">
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('food_order_client.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.barrist-orders.create',$table_id) }}">@lang('messages.new')</a>
                        @endif
                    </p>
