                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::guard('admin')->user()->can('food_order_client.reject'))
                                            <a class="btn btn-primary text-white" href="{{ route('admin.order_kitchens.reject', $order->order_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('reject-form-{{ $order->order_no }}').submit();">
                                                Rejeter
                                            </a>
                                            <form id="reject-form-{{ $order->order_no }}" action="{{ route('admin.order_kitchens.reject', $order->order_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
