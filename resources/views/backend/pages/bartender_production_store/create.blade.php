        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.bartender-production-store.index') }}">@lang('messages.list')</a></li>
         ...
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.bartender-transformation.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
                        <div class="col-sm-6" id="dynamicDiv">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr class="">  
                                ...
                                <option value="{{ $bartender_item->id }}" class="form-control">{{$bartender_item->name}}/{{ $bartender_item->code }}</option>
                                @endforeach
                                </select></td>  
                      ...
                      "<td>"+
                         "<select class='form-control' name='bartender_item_id[]'"+
                            "<option>merci de choisir</option>"+
                             "@foreach($bartender_items as $bartender_item)"+
                                 "<option value='{{ $bartender_item->id }}'>{{ $bartender_item->name }}/{{ $bartender_item->code }}</option>"+
                             "@endforeach>"+
                          "</select>"+
                        "</td>"+
                        "<td>"+
