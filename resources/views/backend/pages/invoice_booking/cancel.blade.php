        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-warning">
                    <h4 class="header-title">Annulation Facture</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('ebms_api.cancelInvoice',$facture->invoice_number) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="invoice_signature">Signature de la Facture</label>
                                <input type="text" value="{{ $facture->invoice_signature }}" name="invoice_signature" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><input type="text" name="item_designation[]" value="{{ $data->article->name }}" class="form-control" readonly /></td>  
                        ...
                        <button type="submit" class="btn btn-danger mt-4 pr-4 pl-4">Annuler</button>
                    </form>
                </div>
            </div>
        </div>
