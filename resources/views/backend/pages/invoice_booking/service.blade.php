                               ...
                               <tr>
                                ...
                                -->
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::guard('admin')->user()->can('invoice_service.validate'))
                                        @if($facture->etat == 0)
                                        ...
                                        @endif
                                        @endif 
                                        @if (Auth::guard('admin')->user()->can('invoice_service.reset'))
                                        @if($facture->etat == 0)
                                         <a href="{{ route('admin.voir-facture.reset', $facture->invoice_number) }}" class="btn btn-success">Annuler</a>
                                        @endif
                                        @endif 
                                        @if (Auth::guard('admin')->user()->can('invoice_service.delete'))
                                        @if($facture->etat == 0)
