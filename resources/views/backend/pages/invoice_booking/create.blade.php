                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <td>@if(Auth::guard('admin')->user()->can('invoice_salle.delete'))<button type='button' class='btn btn-danger remove-tr'><i class='fa fa-trash-o' title='Supprimer la ligne' aria-hidden='false'></i></button>@endif</td> 
                            </tr>
                            ...
                            <tr>  
                                ...
                                <td>@if(Auth::guard('admin')->user()->can('invoice_kidness_space.edit'))<button type='button' class='btn btn-danger remove-tr'><i class='fa fa-trash-o' title='Supprimer la ligne' aria-hidden='false'></i></button>@endif</td> 
                            </tr>
                            ...
                            <tr>  
                                ...
                                <td>@if(Auth::guard('admin')->user()->can('invoice_breakfast.edit'))<button type='button' class='btn btn-danger remove-tr'><i class='fa fa-trash-o' title='Supprimer la ligne' aria-hidden='false'></i></button>@endif</td> 
                            </tr>
