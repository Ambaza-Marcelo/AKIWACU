                               ...
                               <tr>
                                ...
                                -->
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::guard('admin')->user()->can('invoice_kidness_space.validate'))
                                        @if($facture->etat == 0)
                                        ...
                                        @endif 
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('invoice_kidness_space.reset'))
                                        @if($facture->etat == 0)
                                         <a href="{{ route('admin.voir-facture.reset', $facture->invoice_number) }}" class="btn btn-success">Annuler</a>
                                        @endif
                                        @endif 
                                        @if (Auth::guard('admin')->user()->can('invoice_kidness_space.delete'))
                                        @if($facture->etat == 0)
