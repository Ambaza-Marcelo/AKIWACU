                    ...
                    @include('backend.layouts.partials.messages')
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><input type="text" value="@if($factureDetail->drink_id){{ $factureDetail->drink->name }} @elseif($factureDetail->food_item_id){{ $factureDetail->foodItem->name }} @elseif($factureDetail->bartender_item_id){{ $factureDetail->bartenderItem->name }} @elseif($factureDetail->salle_id){{ $factureDetail->salle->name }} @elseif($factureDetail->service_id){{ $factureDetail->service->name }}  @elseif($factureDetail->breakfast_id) {{ $factureDetail->breakFast->name }} @elseif($factureDetail->swiming_pool_id) {{ $factureDetail->swimingPool->name }} @elseif($factureDetail->kidness_space_id) {{ $factureDetail->kidnessSpace->name }} @elseif($factureDetail->room_id) {{ $factureDetail->room->name }} @else {{ $factureDetail->barristItem->name }} @endif" class="form-control" readonly></td>  
