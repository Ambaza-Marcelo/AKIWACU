                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="card">
                                <div class="seo-fact sbg3">
                                    <a href="{{ route('admin.home-consumption-barrist.index',$staff_member_id) }}">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon">
                                                <img src="{{ asset('img/undraw_beer-006.svg') }}" width="200">

                                            @lang('Consommation Barrist')</div>
                                            <h2>
                                            </h2>
                                        </div>
                                    </a>
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="card">
                                <div class="seo-fact sbg6">
                                    <a href="{{ route('admin.home-consumption-food.index',$staff_member_id) }}">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon">
                                                <img src="{{ asset('img/undraw_eating_together-004.svg') }}" width="200">

                                            @lang('Consommation Cuisine')</div>
                                            <h2>
                                            </h2>
                                        </div>
                                    </a>
