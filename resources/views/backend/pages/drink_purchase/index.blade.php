                ...
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('drink_purchase.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.drink-purchases.create') }}">@lang('messages.new')</a>
                        @endif
                    </p>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td><a href="{{ route('admin.drink-purchases.show',$purchase->purchase_no) }}">{{ $purchase->purchase_no }}</a></td>
                                    ...
                                    <td>
                                        ...
                                        @if($purchase->status == 1 || $purchase->status == -1)
                                            <a class="btn btn-primary text-white" href="{{ route('admin.drink-purchases.validate', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('validate-form-{{ $purchase->purchase_no }}').submit();">
                                                Valider
                                            </a>

                                            <form id="validate-form-{{ $purchase->purchase_no }}" action="{{ route('admin.drink-purchases.validate', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if($purchase->status == 2)
                                            <a class="btn btn-primary text-white" href="{{ route('admin.drink-purchases.confirm', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('confirm-form-{{ $purchase->purchase_no }}').submit();">
                                                Confirmer
                                            </a>

                                            <form id="confirm-form-{{ $purchase->purchase_no }}" action="{{ route('admin.drink-purchases.confirm', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if($purchase->status == 3)
                                            <a class="btn btn-primary text-white" href="{{ route('admin.drink-purchases.approuve', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('approuve-form-{{ $purchase->purchase_no }}').submit();">
                                                Approuver
                                            </a>

                                            <form id="approuve-form-{{ $purchase->purchase_no }}" action="{{ route('admin.drink-purchases.approuve', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if (Auth::guard('admin')->user()->can('drink_purchase.reject'))
                                            ...
                                            <a class="btn btn-primary text-white" href="{{ route('admin.drink-purchases.reject', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('reject-form-{{ $purchase->purchase_no }}').submit();">
                                                Rejeter
                                            </a>
                                            @endif
                                            <form id="reject-form-{{ $purchase->purchase_no }}" action="{{ route('admin.drink-purchases.reject', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('drink_purchase.reset'))
                                            ...
                                            <a class="btn btn-primary text-white" href="{{ route('admin.drink-purchases.reset', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('reset-form-{{ $purchase->purchase_no }}').submit();">
                                                Annuler
                                            </a>
                                            @endif
                                            <form id="reset-form-{{ $purchase->purchase_no }}" action="{{ route('admin.drink-purchases.reset', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if (Auth::guard('admin')->user()->can('drink_purchase.create'))
                                        @if($purchase->status == 4)
                                        <a href="{{ route('admin.drink-reception-without-order.create',$purchase->purchase_no)}}" class="btn btn-success">Receptionner Sans Bon de Commande</a>
                                        @endif
                                        @endif
                                        ...
                                        @if (Auth::guard('admin')->user()->can('drink_purchase.delete'))
                                            <a class="btn btn-danger text-white" href="{{ route('admin.drink-purchases.destroy', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('delete-form-{{ $purchase->purchase_no }}').submit();">
                                                @lang('messages.delete')
                                            </a>

                                            <form id="delete-form-{{ $purchase->purchase_no }}" action="{{ route('admin.drink-purchases.destroy', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('DELETE')
                                                @csrf
                                            </form>
                                        @endif
