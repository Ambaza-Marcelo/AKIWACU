                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($purchase->status == 1 || $purchase->status == -1)
                                            <a class="btn btn-primary text-white" href="{{ route('admin.food-purchases.validate', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('validate-form-{{ $purchase->purchase_no }}').submit();">
                                                Valider
                                            </a>

                                            <form id="validate-form-{{ $purchase->purchase_no }}" action="{{ route('admin.food-purchases.validate', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if($purchase->status == 2)
                                            <a class="btn btn-primary text-white" href="{{ route('admin.food-purchases.confirm', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('confirm-form-{{ $purchase->purchase_no }}').submit();">
                                                Confirmer
                                            </a>

                                            <form id="confirm-form-{{ $purchase->purchase_no }}" action="{{ route('admin.food-purchases.confirm', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if($purchase->status == 3)
                                            <a class="btn btn-primary text-white" href="{{ route('admin.food-purchases.approuve', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('approuve-form-{{ $purchase->purchase_no }}').submit();">
                                                Approuver
                                            </a>

                                            <form id="approuve-form-{{ $purchase->purchase_no }}" action="{{ route('admin.food-purchases.approuve', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if (Auth::guard('admin')->user()->can('food_purchase.reject'))
                                            ...
                                            <a class="btn btn-primary text-white" href="{{ route('admin.food-purchases.reject', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('reject-form-{{ $purchase->purchase_no }}').submit();">
                                                Rejeter
                                            </a>
                                            @endif
                                            <form id="reject-form-{{ $purchase->purchase_no }}" action="{{ route('admin.food-purchases.reject', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('PUT')
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if (Auth::guard('admin')->user()->can('food_purchase.delete'))
                                            <a class="btn btn-danger text-white" href="{{ route('admin.food-purchases.destroy', $purchase->purchase_no) }}"
                                            onclick="event.preventDefault(); document.getElementById('delete-form-{{ $purchase->purchase_no }}').submit();">
                                                @lang('messages.delete')
                                            </a>

                                            <form id="delete-form-{{ $purchase->purchase_no }}" action="{{ route('admin.food-purchases.destroy', $purchase->purchase_no) }}" method="POST" style="display: none;">
                                                @method('DELETE')
                                                @csrf
                                            </form>
                                        @endif
