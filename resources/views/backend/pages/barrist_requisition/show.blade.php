...
@section('title')
@lang('Les requisitions') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Les requisitions')</h4>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Details sur le Bon de requisition No : {{$code}}</h4>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>@if($requisition->drink_id){{ $requisition->drink->name }} @else {{ $requisition->food->name }} @endif</td>
                                    <td>@if($requisition->drink_id){{ $requisition->drink->code }} @else {{ $requisition->food->code }} @endif</td>
