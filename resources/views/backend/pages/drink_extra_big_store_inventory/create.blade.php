        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.drink-extra-big-store-inventory.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-success">
                    ...
                    <form action="{{ route('admin.drink-extra-big-store-inventory.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="INVENTAIRE AU GRAND STOCK DES BOISSONS DU {{ date('d') }} ,{{date('M')}} {{ date('Y')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description" id="description">
                              INVENTAIRE AU GRAND STOCK DES BOISSONS DU {{ date('d') }} ,{{date('M')}} {{ date('Y')}}
                            </textarea>
                        </div>
