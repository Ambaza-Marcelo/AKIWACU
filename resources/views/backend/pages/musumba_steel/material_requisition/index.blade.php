            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.create'))
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.validate'))
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.confirm'))
                                        @if($requisition->status == 2)
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.approuve'))
                                        ...
                                        @endif
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.reject'))
                                        ...
                                        @endif
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.reset'))
                                        ...
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.edit'))
                                        ...
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_material_requisition.delete'))
