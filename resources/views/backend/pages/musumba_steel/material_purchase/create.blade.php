        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.ms-material-purchases.index') }}">@lang('messages.list')</a></li>
         ...
         <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ms-material-purchases.store') }}" method="post" id="dynamic_form">
                        @csrf
                    <div class="row">
