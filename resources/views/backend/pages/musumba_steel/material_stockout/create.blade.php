        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.ms-material-stockouts.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ms-material-stockouts.store') }}" method="POST">
                        @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="origin_store_id">@lang('Stock Origine')<strong style="color: red;">*</strong></label>
                                    <select class="form-control" name="origin_store_id" id="origin_store_id" required>
                                        ...
                                        <option value="{{ $material_origin_store->id }}">{{ $material_origin_store->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
