        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.musumba-steel-clients.store') }}" method="POST">
                        @csrf
                        <div class="row">
                        <div class="col-md-4">
                        <div class="form-group">
                            <label for="customer_name">Nom du Client *</label>
                            <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Entrer le nom du client" required>
                        </div>
                        </div>
                        <div class="col-md-4">
                        <div class="form-group">
