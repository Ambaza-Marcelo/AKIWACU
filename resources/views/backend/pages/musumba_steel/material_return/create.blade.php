...
@section('title')
@lang('messages.return') - @lang('messages.admin_panel')
@endsection
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.material-return.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('messages.return')</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.material-return.store') }}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            <tr>
                                ...
                                <th>@lang('Returned unit')</th>
                                <th>@lang('Returned Price')</th>
                                <!--
                            ...
                            <tr>  
                                ...
                                <td><input type="number" name="quantity_transfered[]" value="{{ $data->quantity_transfered }}" class="form-control"  readonly /></td>  
                                ...
                                <td><input type="number" name="quantity_returned[]" value="{{ $data->quantity_transfered }}" class="form-control" min="0" /></td>  
                                <td>
                    ...
                    -->
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description" id="description" placeholder="Enter Desccription">
                                RETOUR DES MATERIELS AU GRAND STOCK
                            </textarea>
                        </div>
