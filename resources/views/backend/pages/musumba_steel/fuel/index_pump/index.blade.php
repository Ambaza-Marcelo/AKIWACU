            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('musumba_steel_index_pump.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.ms-fuel-index-pumps.create') }}">Nouveau</a>
                        @endif
                    </p>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('musumba_steel_index_pump.edit'))
                                            <a class="btn btn-success text-white" href="{{ route('admin.ms-fuel-index-pumps.edit',$fuel_index_pump->id)}}">Editer</a>
                                        @endif

                                        @if (Auth::guard('admin')->user()->can('musumba_steel_index_pump.delete'))
                                            <a class="btn btn-danger text-white" href="{{ route('admin.ms-fuel-index-pumps.destroy',$fuel_index_pump->id)}}"
                                            ...
                                            <form id="delete-form-" action="{{ route('admin.ms-fuel-index-pumps.destroy',$fuel_index_pump->id)}}" method="POST" style="display: none;">
                                                @method('DELETE')
                                                @csrf
                                            </form>
                                        @endif
