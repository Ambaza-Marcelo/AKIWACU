        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ms-fuel-receptions.store') }}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                         ...
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <td><input type="number" name="purchase_price[]" class="form-control"  step="any" min="0" value="{{ $data->purchase_price }}" /></td> 
                                <td>     
                            </tr>
                            @endforeach
                        </table> 
