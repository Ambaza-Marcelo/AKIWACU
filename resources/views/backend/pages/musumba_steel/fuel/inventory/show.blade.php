                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{{ $inventory->pump->name }}</td>
                                    <td>{{ $inventory->pump->fuel->name }}</td>
                                    <td>{{ $inventory->quantity }}</td>
                                    <td>{{ number_format($inventory->cost_price,0,',','.') }}</td>
                                    <td>{{ number_format($inventory->total_cost_value,0,',','.') }}</td>
                                    <td>{{ $inventory->new_quantity }}</td>
                                    <td>{{ $inventory->new_cost_price }}</td>
                                    <td>{{ $inventory->new_total_cost_value }}</td>
