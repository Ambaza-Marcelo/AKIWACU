        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.ms-material-receptions.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ms-material-reception-without-order.store') }}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                <div class="form-group">
                                    <label for="destination_store_id">@lang('Destination Stock')<strong style="color: red;">*</strong></label>
                                    <select class="form-control" name="destination_store_id" id="destination_store_id">
                                        ...
                                        <option value="{{ $destination_store->id }}" class="form-control">{{ $destination_store->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        </div>
                            ...
                            <tr>  
                                ...
                                <td>
                                    <select class="form-control" name="unit[]" id="unit">
                                        ...
                                        <option value="mg" {{ $data->unit == 'mg' ? 'selected' : '' }} class="form-control">Milligrames</option>
