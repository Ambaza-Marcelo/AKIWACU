...
@section('title')
@lang('drink supplier orders') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('drink supplier orders')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.drink-supplier-orders.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('drink supplier orders')</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-success">
                    ...
                    <form action="{{ route('admin.drink-supplier-orders.store') }}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-sm-6">
