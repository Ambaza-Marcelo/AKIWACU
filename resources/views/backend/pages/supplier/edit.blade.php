...
@section('title')
@lang('Modifier du fournisseur') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Modifier du fournisseur')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.suppliers.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Modifier du fournisseur')</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Modifier du Fournisseur</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="telephone" name="telephone" value="{{ $supplier->telephone }}">
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mail" name="mail" value="{{ $supplier->mail }}">
                        </div>
                        </div>
                    </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="vat_supplier_payer" value="0" @if($supplier->vat_supplier_payer == '0') checked="checked" @endif class="form-control">
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label class="text">Assujetti
                                    <input type="checkbox" name="vat_supplier_payer" value="1" @if($supplier->vat_supplier_payer == '1') checked="checked" @endif class="form-control">
                                    </label>
                                </div>
                            </div>
                        </div>
