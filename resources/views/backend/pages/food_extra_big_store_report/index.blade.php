...
@section('title')
@lang('RAPPORT DU STOCK DE NOURRITURES (EXTRA-GRAND STOCK)') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('RAPPORT DU STOCK DE NOURRITURES (EXTRA-GRAND STOCK)')</h4>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.food-extra-big-store-report.export-to-excel')}}" method="GET">
                    ...
                    <form action="{{ route('admin.food-extra-big-store-report.export-to-pdf')}}" method="GET">
                        <p class="float-right mb-2">
