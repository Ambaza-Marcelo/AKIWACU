    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                ...
                <form action="{{ route('admin.facture-rapport.bartender')}}" method="GET">
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($facture->cancelled_invoice != 1)
                                         <a href="{{ route('admin.bartender-note-de-credit.create', $facture->invoice_number) }}" class="btn btn-success">Facture d'Avoir</a>
                                        @endif
                                        @endif 
                                        @endif
                                        ...
                                        @if($facture->etat == 1 || $facture->etat == 01)
                                        @if($facture->cancelled_invoice != 1)
                                         <a href="{{ route('admin.bartender-remboursement-caution.create', $facture->invoice_number) }}" class="btn btn-success">Remboursement Caution</a>
                                        @endif
                                        @endif
                                        @endif 
