        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.bartender-invoices.index') }}">@lang('messages.list')</a></li>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('ebms_api-facture-bartender.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            @if($table_id)
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="cancelled_invoice_ref" placeholder="Reference Facture Annulé" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                ...
                                <option value="{{ $order->bartender_item_id }}" class="form-control">{{ $order->bartenderItem->name }}</option>
                                </select></td>  
                                ...
                                <td><input type="text" name="bartender_order_no[]" value="{{ $order->order_no }}" class="form-control" readonly/></td>
                                <td>@if(Auth::guard('admin')->user()->can('invoice_drink.delete'))<button type='button' class='btn btn-danger remove-tr'><i class='fa fa-trash-o' title='Supprimer la ligne' aria-hidden='false'></i></button>@endif</td> 
                            </tr> 
                            @endforeach
                        </table> 
                          ...
                          "<select class='form-control' name='bartender_item_id[]'"+
                            "<option>merci de choisir</option>"+
                             "@foreach($bartender_items as $bartender_item)"+
                                 "<option value='{{ $bartender_item->id }}'>{{ $bartender_item->name }}</option>"+
                             "@endforeach>"+
                          "</select>"+
                        "</td>"+
                        "<td>"+
