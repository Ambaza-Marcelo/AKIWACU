        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.facture.reset', $facture->invoice_number) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="col-md-12">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><input type="text" name="item_designation[]" value="{{ $data->drink->name }}" class="form-control" readonly /></td>  
