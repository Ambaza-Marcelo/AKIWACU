        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.material-stockouts.storeFromBig') }}" method="POST">
                        @csrf
                    ...
                    <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="origin_extra_store_id">@lang('Stock Origine')<strong style="color: red;">*</strong></label>
