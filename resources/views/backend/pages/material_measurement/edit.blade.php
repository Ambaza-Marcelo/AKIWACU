        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.material-measurement.update',$material_measurement->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="purchase_unit" name="purchase_unit" value="{{ $material_measurement->purchase_unit }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="stockout_unit">Unité de sortie</label>
                                    <input type="text" class="form-control" id="stockout_unit" name="stockout_unit" value="{{ $material_measurement->stockout_unit }}">
                                </div>
                            </div>
                        </div>
