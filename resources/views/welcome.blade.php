          ...
          <div class="tab-pane fade active show" id="">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ asset('img/eden_logo.png')}}" class="glightbox"><img src="{{ asset('img/eden_logo.png')}}" class="menu-img img-fluid" alt=""></a>
                <h4>{{ $restauration->name }}</h4>
                <p class="ingredients">
                  
                </p>
                <p class="price">
                  {{ number_format($restauration->selling_price,0,',',' ') }} BIF
                </p>
              </div><!-- Menu Item -->
              @endforeach
              {{$restaurations->links()}}
