...
class CreateSotbMaterialMdStoreInventoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sotb_material_md_store_inventory_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sotb_material_md_store_inventory_details');
    }
}
