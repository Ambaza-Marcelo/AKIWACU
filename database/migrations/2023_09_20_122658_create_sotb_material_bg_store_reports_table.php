...
class CreateSotbMaterialBgStoreReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sotb_material_bg_store_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sotb_material_bg_store_reports');
    }
}
