...
class CreateVirtualDrinkSmStoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('virtual_drink_sm_stores', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('virtual_drink_sm_stores');
    }
}
