...
class CreateMaterialSmallStoreInventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('material_small_store_inventories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('material_small_store_inventories');
    }
}
