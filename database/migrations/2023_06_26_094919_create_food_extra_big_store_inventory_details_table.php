...
class CreateFoodExtraBigStoreInventoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('food_extra_big_store_inventory_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('food_extra_big_store_inventory_details');
    }
}
