...
class CreateMsFuelInventoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ms_fuel_inventory_details', function (Blueprint $table) {
            $table->id();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('ms_fuel_inventory_details');
