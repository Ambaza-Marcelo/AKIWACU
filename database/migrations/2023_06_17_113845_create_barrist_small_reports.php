...
class CreateBarristSmallReports extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('barrist_small_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('barrist_small_reports');
    }
}
