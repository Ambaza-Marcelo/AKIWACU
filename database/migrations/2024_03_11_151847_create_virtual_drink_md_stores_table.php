...
class CreateVirtualDrinkMdStoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('virtual_drink_md_stores', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('virtual_drink_md_stores');
    }
}
