...
class CreateBartenderSmallReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bartender_small_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bartender_small_reports');
    }
}
