...
class CreateFoodSmallStoreDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('food_small_store_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('food_small_store_details');
    }
}
