...
class CreateMaterialStockoutDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('material_stockout_details', function (Blueprint $table) {
            $table->id();
            $table->date('date');
    ...
    {
        Schema::dropIfExists('material_stockout_details');
    }
}
