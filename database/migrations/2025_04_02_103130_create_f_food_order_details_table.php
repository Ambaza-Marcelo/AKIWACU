...
class CreateFFoodOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('f_food_order_details', function (Blueprint $table) {
            $table->id();
            $table->dateTime('date');
    ...
    {
        Schema::dropIfExists('f_food_order_details');
    }
}
