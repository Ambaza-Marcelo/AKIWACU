...
class CreateBarristInventoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('barrist_inventory_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('barrist_inventory_details');
    }
}
