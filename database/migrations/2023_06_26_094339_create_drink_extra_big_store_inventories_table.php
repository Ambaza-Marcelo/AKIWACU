...
class CreateDrinkExtraBigStoreInventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drink_extra_big_store_inventories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('drink_extra_big_store_inventories');
    }
}
