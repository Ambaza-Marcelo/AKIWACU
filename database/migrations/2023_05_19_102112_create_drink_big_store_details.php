...
class CreateDrinkBigStoreDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drink_big_store_details', function (Blueprint $table) {
            $table->id();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('drink_big_store_details');
