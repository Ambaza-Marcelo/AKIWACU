...
class CreateSotbMaterialMdStoreReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sotb_material_md_store_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sotb_material_md_store_reports');
    }
}
