...
class CreateVirtualMaterialBgStoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('virtual_material_bg_stores', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('virtual_material_bg_stores');
    }
}
