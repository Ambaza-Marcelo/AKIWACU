...
class CreateMaterialExtraBigStoreInventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('material_extra_big_store_inventories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('material_extra_big_store_inventories');
    }
}
