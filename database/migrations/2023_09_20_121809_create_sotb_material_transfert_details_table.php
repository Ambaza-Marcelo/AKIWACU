...
class CreateSotbMaterialTransfertDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sotb_material_transfert_details', function (Blueprint $table) {
            $table->id();
            $table->date('date');
    ...
    {
        Schema::dropIfExists('sotb_material_transfert_details');
    }
}
