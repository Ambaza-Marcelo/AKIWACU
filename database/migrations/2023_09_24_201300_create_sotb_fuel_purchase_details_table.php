...
class CreateSotbFuelPurchaseDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sotb_fuel_purchase_details', function (Blueprint $table) {
            $table->id();
            $table->date('date');
    ...
    {
        Schema::dropIfExists('sotb_fuel_purchase_details');
    }
}
