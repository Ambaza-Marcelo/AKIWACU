...
class CreateFoodBigStoreDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('food_big_store_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('food_big_store_details');
    }
}
