...
class CreateFBartenderOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('f_bartender_order_details', function (Blueprint $table) {
            $table->id();
            $table->dateTime('date');
    ...
    {
        Schema::dropIfExists('f_bartender_order_details');
    }
}
