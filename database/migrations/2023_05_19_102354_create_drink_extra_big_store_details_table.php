...
class CreateDrinkExtraBigStoreDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drink_extra_big_store_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('drink_extra_big_store_details');
    }
}
