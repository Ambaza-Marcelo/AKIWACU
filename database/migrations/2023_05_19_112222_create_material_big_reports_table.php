...
class CreateMaterialBigReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('material_big_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('material_big_reports');
    }
}
