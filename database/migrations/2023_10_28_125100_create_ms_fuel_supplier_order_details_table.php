...
class CreateMsFuelSupplierOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ms_fuel_supplier_order_details', function (Blueprint $table) {
            $table->id();
            $table->date('date');
    ...
    {
        Schema::dropIfExists('ms_fuel_supplier_order_details');
    }
}
