...
class CreateFoodExtraBigStoreInventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('food_extra_big_store_inventories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('food_extra_big_store_inventories');
    }
}
