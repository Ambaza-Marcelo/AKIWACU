...
class CreateMsMaterialPurchaseDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ms_material_purchase_details', function (Blueprint $table) {
            $table->id();
            $table->date('date');
    ...
    {
        Schema::dropIfExists('ms_material_purchase_details');
    }
}
