...
class CreateBartenderStockoutDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bartender_stockout_details', function (Blueprint $table) {
            $table->id();
            $table->date('date');
            ...
            $table->bigInteger('bartender_store_id')->unsigned();
    ...
    {
        Schema::dropIfExists('bartender_stockout_details');
    }
}
