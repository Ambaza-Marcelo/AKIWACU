...
class CreateDrinkSmallStoreInventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drink_small_store_inventories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('drink_small_store_inventories');
    }
}
