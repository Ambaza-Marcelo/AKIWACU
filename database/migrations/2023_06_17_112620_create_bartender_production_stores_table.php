...
class CreateBartenderProductionStoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bartender_production_stores', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bartender_production_stores');
    }
}
