...
class CreateDrinkExtraBigStoreInventoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drink_extra_big_store_inventory_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('drink_extra_big_store_inventory_details');
    }
}
