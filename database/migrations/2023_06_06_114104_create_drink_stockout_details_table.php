...
class CreateDrinkStockoutDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drink_stockout_details', function (Blueprint $table) {
            $table->id();
            $table->dateTime('date');
    ...
    {
        Schema::dropIfExists('drink_stockout_details');
    }
}
