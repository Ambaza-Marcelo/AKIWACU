...
class CreateBartenderStockinDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bartender_stockin_details', function (Blueprint $table) {
            $table->id();
            $table->dateTime('date');
    ...
    {
        Schema::dropIfExists('bartender_stockin_details');
    }
}
