...
class CreateMaterialBigStoreInventoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('material_big_store_inventory_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('material_big_store_inventory_details');
    }
}
