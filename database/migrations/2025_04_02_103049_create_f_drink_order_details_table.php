...
class CreateFDrinkOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('f_drink_order_details', function (Blueprint $table) {
            $table->id();
            $table->dateTime('date');
    ...
    {
        Schema::dropIfExists('f_drink_order_details');
    }
}
